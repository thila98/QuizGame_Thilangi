 ...
 * @author Thilangi
 */
public class AdditionQuiz extends javax.swing.JFrame {
     ...
     */
    public void submit() {
        String Username = unameaddition.getText();
        answerCheck();
        try {
            Connection con = connectionProvider.getCon();
            Statement st = con.createStatement();
     ...
     * @param Username
     */
    public AdditionQuiz(String Username) {
        initComponents();
        ...
        try {
            ...
            while (rs.next()) {
                unameaddition.setText(rs.getString(2));
            }
            ResultSet rs1 = st.executeQuery("select * from question where id='"+questionId+"'");
            while (rs1.next()) {
                jLabel14.setText(rs1.getString(1));
    ...
    private void initComponents() {
        ...
        stuloginclosebtn1 = new javax.swing.JButton();
        ...
        unameaddition = new javax.swing.JLabel();
        ...
        jLabel1.setText("What is the answer of 234 + 345 ?");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 570, 40));
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 414, 840, 30));
        ...
        stuloginclosebtn1.setBackground(new java.awt.Color(255, 255, 255));
        stuloginclosebtn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8_delete_40px.png"))); // NOI18N
        stuloginclosebtn1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                stuloginclosebtn1MouseClicked(evt);
            }
        });
        jPanel2.add(stuloginclosebtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 10, 40, 40));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 56, 840, 450));

        jLabel15.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        ...
        jLabel17.setText("D");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, -1));
        ...
        jLabel19.setText("I");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, -1, -1));
        ...
        jLabel21.setText("I");
        jPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, -1, -1));

        jLabel22.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(204, 255, 204));
        jLabel22.setText("O");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, -1, -1));
        ...
        unameaddition.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        unameaddition.setForeground(new java.awt.Color(255, 255, 255));
        unameaddition.setText("test1");
        jPanel1.add(unameaddition, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, -1, -1));
    ...
    private void stuloginclosebtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_stuloginclosebtn1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_stuloginclosebtn1MouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdditionQuiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton stuloginclosebtn1;
    private javax.swing.JLabel unameaddition;
