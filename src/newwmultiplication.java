 ...
 * @author Thilangi
 */
public class newwmultiplication extends javax.swing.JFrame {

    /**
     * Creates new form newwmultiplication
     */
    public newwmultiplication() {
        initComponents();
        try {
            Connection con = connectionProvider.getCon();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("Select count(id) from multiplication");
            if (rs.first()) {
                int id = rs.getInt(1);
                id = id + 1;
    ...
    private void anbtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anbtnSaveActionPerformed
        ...
        try {
            Connection con = connectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("insert into multiplication values(?,?,?,?,?,?,?)");
            ps.setString(1, id);
            ps.setString(2, name);
            ps.setString(3, opt1);
            ps.setString(4, opt2);
            ...
            setVisible(false);
            new newwmultiplication().setVisible(true);
        } catch (Exception e) {
            JFrame jf = new JFrame();
            jf.setAlwaysOnTop(true);
            JOptionPane.showMessageDialog(jf, e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newwmultiplication.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
