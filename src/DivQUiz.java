 ...
 * @author Thilangi
 */
public class DivQUiz extends javax.swing.JFrame {
    ...
    public void question() {
        try {
            ...
            ResultSet rs1 = st.executeQuery("select * from division where id='"+questionId+"'");
            while (rs1.next()) {
     ...
     * @param Username
     */
    public DivQUiz(String Username) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("What is the answer of 10 / 2 ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DivQUiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
