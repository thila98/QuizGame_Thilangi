 ...
 * @author Thilangi
 */
public class newrandom extends javax.swing.JFrame {

    /**
     * Creates new form newrandom
     */
    public newrandom() {
        initComponents();
        try {
            ...
            ResultSet rs = st.executeQuery("Select count(id) from random");
            if (rs.first()) {
                int id = rs.getInt(1);
                id = id + 1;
                String str = String.valueOf(id);
                ancount1.setText(str);
            } else {
                ancount1.setText("1");
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        ancount1 = new javax.swing.JLabel();
        ananswera = new javax.swing.JTextField();
        anquestion1 = new javax.swing.JTextField();
        anopt1a = new javax.swing.JTextField();
        anopt2a = new javax.swing.JTextField();
        anopt3a = new javax.swing.JTextField();
        anopt4a = new javax.swing.JTextField();
        ...
        ancount1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ancount1.setForeground(new java.awt.Color(0, 153, 0));
        ancount1.setText("00");
        jPanel1.add(ancount1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 120, -1, -1));

        ananswera.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ananswera.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(ananswera, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 370, 380, -1));

        anquestion1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        anquestion1.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(anquestion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 170, 380, -1));

        anopt1a.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        anopt1a.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(anopt1a, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 210, 380, -1));

        anopt2a.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        anopt2a.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(anopt2a, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 250, 380, -1));

        anopt3a.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        anopt3a.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(anopt3a, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 290, 380, -1));

        anopt4a.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        anopt4a.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(anopt4a, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, 380, -1));
    ...
    private void anbtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anbtnSaveActionPerformed
        ...
        String id = ancount1.getText();
        String name = anquestion1.getText();
        String opt1 = anopt1a.getText();
        String opt2 = anopt2a.getText();
        String opt3 = anopt3a.getText();
        String opt4 = anopt4a.getText();
        String answer = ananswera.getText();

        try {
            Connection con = connectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("insert into random values(?,?,?,?,?,?,?)");
            ps.setString(1, id);
            ps.setString(2, name);
            ps.setString(3, opt1);
            ps.setString(4, opt2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newrandom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField ananswera;
    private javax.swing.JButton anbtnClear;
    private javax.swing.JButton anbtnSave;
    private javax.swing.JButton anclose;
    private javax.swing.JLabel ancount1;
    private javax.swing.JTextField anopt1a;
    private javax.swing.JTextField anopt2a;
    private javax.swing.JTextField anopt3a;
    private javax.swing.JTextField anopt4a;
    private javax.swing.JTextField anquestion1;
