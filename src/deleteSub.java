 ...
 * @author Thilangi
 */
public class deleteSub extends javax.swing.JFrame {

    /**
     * Creates new form deleteSub
     */
    public deleteSub() {
        initComponents();
    }
    ...
    private void dubtnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dubtnsearchActionPerformed
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from subtraction where id='"+id+"'");
            if (rs.first()) {
    ...
    private void dqbtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dqbtnUpdateActionPerformed
        ...
        try {
            Connection con = connectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update subtraction set name=?,opt1=?,opt2=?,opt3=?,opt4=?,answer=? where id=?");
            ps.setString(1, name);
            ps.setString(2, opt1);
            ps.setString(3, opt2);
            ps.setString(4, opt3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteSub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
