 ...
 * @author Thilangi
 */
public class Newaddition extends javax.swing.JFrame {
    ...
    private void anbtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anbtnSaveActionPerformed
        ...
        try {
            ...
            setVisible(false);
            new Newaddition().setVisible(true);
        } catch (Exception e) {
            JFrame jf = new JFrame();
            jf.setAlwaysOnTop(true);
            JOptionPane.showMessageDialog(jf, e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Newaddition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
