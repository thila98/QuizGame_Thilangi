 ...
 * @author Thilangi
 */
public class SubQuiz extends javax.swing.JFrame {
    ...
    public void question() {
        try {
            ...
            ResultSet rs1 = st.executeQuery("select * from subtraction where id='"+questionId+"'");
            while (rs1.next()) {
     ...
     */
    public void submit() {
        String Username = unamesubtraction.getText();
        answerCheck();
        try {
            Connection con = connectionProvider.getCon();
            Statement st = con.createStatement();
     ...
     * @param Username
     */
    public SubQuiz(String Username) {
        initComponents();
        ...
        try {
            ...
            while (rs.next()) {
                unamesubtraction.setText(rs.getString(2));
            }
            ResultSet rs1 = st.executeQuery("select * from subtraction where id='"+questionId+"'");
            while (rs1.next()) {
                jLabel14.setText(rs1.getString(1));
    ...
    private void initComponents() {
        ...
        unamesubtraction = new javax.swing.JLabel();
        ...
        jLabel1.setText("What is the answer of 5 - 3 ?");
        ...
        jLabel19.setText("T");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, -1, -1));

        jLabel20.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(204, 255, 204));
        jLabel20.setText("R");
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, -1, -1));
        ...
        jLabel22.setText("C");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, -1, -1));
        ...
        unamesubtraction.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        unamesubtraction.setForeground(new java.awt.Color(255, 255, 255));
        unamesubtraction.setText("test1");
        jPanel1.add(unamesubtraction, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, -1, -1));
        ...
        jLabel25.setText("I");
        jPanel1.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubQuiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel unamesubtraction;
