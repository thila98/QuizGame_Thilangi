 ...
 * @author Thilangi
 */
public class adddnew extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adddnew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
