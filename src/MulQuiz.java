 ...
 * @author Thilangi
 */
public class MulQuiz extends javax.swing.JFrame {
    ...
    public void question() {
        try {
            ...
            ResultSet rs1 = st.executeQuery("select * from multiplication where id='"+questionId+"'");
            while (rs1.next()) {
     ...
     */
    public void submit() {
        String Username = unamemultiplication.getText();
        answerCheck();
        try {
            Connection con = connectionProvider.getCon();
            Statement st = con.createStatement();
     ...
     * @param Username
     */
    public MulQuiz(String Username) {
        initComponents();
        ...
        try {
            ...
            while (rs.next()) {
                unamemultiplication.setText(rs.getString(2));
            }
            ResultSet rs1 = st.executeQuery("select * from multiplication where id='"+questionId+"'");
            while (rs1.next()) {
                jLabel14.setText(rs1.getString(1));
    ...
    private void initComponents() {
        ...
        unamemultiplication = new javax.swing.JLabel();
        ...
        jLabel1.setText("What is the answer of 2 * 3 ?");
        ...
        jLabel18.setText("L");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, -1));
        ...
        jLabel22.setText("O");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, -1, -1));
        ...
        unamemultiplication.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        unamemultiplication.setForeground(new java.awt.Color(255, 255, 255));
        unamemultiplication.setText("test1");
        jPanel1.add(unamemultiplication, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, -1, -1));
        ...
        jLabel24.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        ...
        jLabel25.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(204, 255, 204));
        jLabel25.setText("P");
        jPanel1.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, -1));

        jLabel26.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(204, 255, 204));
        jLabel26.setText("I");
        jPanel1.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, -1, -1));

        jLabel27.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        jLabel27.setForeground(new java.awt.Color(204, 255, 204));
        jLabel27.setText("C");
        jPanel1.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, -1, -1));

        jLabel28.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
        jLabel28.setForeground(new java.awt.Color(204, 255, 204));
        jLabel28.setText("A");
        jPanel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, -1, -1));

        jLabel29.setFont(new java.awt.Font("Curlz MT", 1, 36)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MulQuiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel unamemultiplication;
